...
const SECTIONS = [
  ...
  },
  {
    ...
    steps: [
      ...
      'On a result with an image, Try on skin takes a photo of the placement and has Gemini draw the design onto it as a healed tattoo (needs a Gemini key; the photo is sent to Google). Save the result as a variant to keep it.',
