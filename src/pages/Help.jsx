...
const SECTIONS = [
  {
    ...
    steps: [
      ...
      'Click any photo and it fills the screen. Arrow keys drive it: ←/→ moves through this artist’s work, ↑/↓ jumps between artists, G generates a concept in this artist’s style, I opens their info & notes, Esc returns to the Wall. On a phone, or without a keyboard, tap × Close in the top-left corner.',
      'Leave the mouse still and the viewer’s controls fade away, leaving just the image; move it, press a key or tap the screen and they return. The @handle link opens the artist’s Instagram in a new tab.',
