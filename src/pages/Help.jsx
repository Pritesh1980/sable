...
const SECTIONS = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Click a saved concept and it fills the screen like the artists’ Wall; Esc or × Close (top-left) takes you back. On a phone, swipe left/right between concepts and tap the image for Delete and Variants. Press I for its prompt, response, style matching and AI results — save multiple outputs as variants, each with an image, text, notes and a rating; mark the strongest as Best.',
