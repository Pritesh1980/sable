# Tattoo — Project Context for Codex
...
- **AI**: Codex API (Codex-sonnet-4-20250514) for concept image generation and artist style matching
...
- Text prompt input → generated concept image via Codex API
...
Then say: **"Build the MVP per AGENTS.md"**
