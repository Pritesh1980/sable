...
demo seed version. The bounded shipped demo WebPs are precached for offline use;
personal reference images are cached on demand. Personalised artwork requires explicit
