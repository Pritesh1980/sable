...
data with the backup's contents, so it's also how you move everything to a new device or
recover after clearing your browser.

## When to back up

- **Before clearing your browser data** or its site storage.
- **When switching devices** — export on the old one, import on the new one.
